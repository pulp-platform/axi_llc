...
module axi_llc_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[ 8] = (reg_addr == AXI_LLC_CFG_SET_PARTITION0_LOW_OFFSET);
    addr_hit[ 9] = (reg_addr == AXI_LLC_CFG_SET_PARTITION0_HIGH_OFFSET);
    addr_hit[10] = (reg_addr == AXI_LLC_CFG_SET_PARTITION1_LOW_OFFSET);
    addr_hit[11] = (reg_addr == AXI_LLC_CFG_SET_PARTITION1_HIGH_OFFSET);
    addr_hit[12] = (reg_addr == AXI_LLC_CFG_SET_PARTITION2_LOW_OFFSET);
    addr_hit[13] = (reg_addr == AXI_LLC_CFG_SET_PARTITION2_HIGH_OFFSET);
    addr_hit[14] = (reg_addr == AXI_LLC_CFG_SET_PARTITION3_LOW_OFFSET);
    addr_hit[15] = (reg_addr == AXI_LLC_CFG_SET_PARTITION3_HIGH_OFFSET);
    addr_hit[16] = (reg_addr == AXI_LLC_CFG_SET_PARTITION4_LOW_OFFSET);
    addr_hit[17] = (reg_addr == AXI_LLC_CFG_SET_PARTITION4_HIGH_OFFSET);
    addr_hit[18] = (reg_addr == AXI_LLC_CFG_SET_PARTITION5_LOW_OFFSET);
    addr_hit[19] = (reg_addr == AXI_LLC_CFG_SET_PARTITION5_HIGH_OFFSET);
    addr_hit[20] = (reg_addr == AXI_LLC_CFG_SET_PARTITION6_LOW_OFFSET);
    addr_hit[21] = (reg_addr == AXI_LLC_CFG_SET_PARTITION6_HIGH_OFFSET);
    addr_hit[22] = (reg_addr == AXI_LLC_CFG_SET_PARTITION7_LOW_OFFSET);
    addr_hit[23] = (reg_addr == AXI_LLC_CFG_SET_PARTITION7_HIGH_OFFSET);
    addr_hit[24] = (reg_addr == AXI_LLC_CFG_SET_PARTITION8_LOW_OFFSET);
    addr_hit[25] = (reg_addr == AXI_LLC_CFG_SET_PARTITION8_HIGH_OFFSET);
    addr_hit[26] = (reg_addr == AXI_LLC_CFG_SET_PARTITION9_LOW_OFFSET);
    addr_hit[27] = (reg_addr == AXI_LLC_CFG_SET_PARTITION9_HIGH_OFFSET);
    addr_hit[28] = (reg_addr == AXI_LLC_CFG_SET_PARTITION10_LOW_OFFSET);
    addr_hit[29] = (reg_addr == AXI_LLC_CFG_SET_PARTITION10_HIGH_OFFSET);
    addr_hit[30] = (reg_addr == AXI_LLC_CFG_SET_PARTITION11_LOW_OFFSET);
    addr_hit[31] = (reg_addr == AXI_LLC_CFG_SET_PARTITION11_HIGH_OFFSET);
    addr_hit[32] = (reg_addr == AXI_LLC_CFG_SET_PARTITION12_LOW_OFFSET);
    addr_hit[33] = (reg_addr == AXI_LLC_CFG_SET_PARTITION12_HIGH_OFFSET);
    addr_hit[34] = (reg_addr == AXI_LLC_CFG_SET_PARTITION13_LOW_OFFSET);
    addr_hit[35] = (reg_addr == AXI_LLC_CFG_SET_PARTITION13_HIGH_OFFSET);
    addr_hit[36] = (reg_addr == AXI_LLC_CFG_SET_PARTITION14_LOW_OFFSET);
    addr_hit[37] = (reg_addr == AXI_LLC_CFG_SET_PARTITION14_HIGH_OFFSET);
    addr_hit[38] = (reg_addr == AXI_LLC_COMMIT_CFG_OFFSET);
    addr_hit[39] = (reg_addr == AXI_LLC_COMMIT_PARTITION_CFG_OFFSET);
    addr_hit[40] = (reg_addr == AXI_LLC_FLUSHED_LOW_OFFSET);
    addr_hit[41] = (reg_addr == AXI_LLC_FLUSHED_HIGH_OFFSET);
    addr_hit[42] = (reg_addr == AXI_LLC_BIST_OUT_LOW_OFFSET);
    addr_hit[43] = (reg_addr == AXI_LLC_BIST_OUT_HIGH_OFFSET);
    addr_hit[44] = (reg_addr == AXI_LLC_SET_ASSO_LOW_OFFSET);
    addr_hit[45] = (reg_addr == AXI_LLC_SET_ASSO_HIGH_OFFSET);
    addr_hit[46] = (reg_addr == AXI_LLC_NUM_LINES_LOW_OFFSET);
    addr_hit[47] = (reg_addr == AXI_LLC_NUM_LINES_HIGH_OFFSET);
    addr_hit[48] = (reg_addr == AXI_LLC_NUM_BLOCKS_LOW_OFFSET);
    addr_hit[49] = (reg_addr == AXI_LLC_NUM_BLOCKS_HIGH_OFFSET);
    addr_hit[50] = (reg_addr == AXI_LLC_VERSION_LOW_OFFSET);
    addr_hit[51] = (reg_addr == AXI_LLC_VERSION_HIGH_OFFSET);
    addr_hit[52] = (reg_addr == AXI_LLC_FLUSHED_SET0_LOW_OFFSET);
    addr_hit[53] = (reg_addr == AXI_LLC_FLUSHED_SET0_HIGH_OFFSET);
    addr_hit[54] = (reg_addr == AXI_LLC_FLUSHED_SET1_LOW_OFFSET);
    addr_hit[55] = (reg_addr == AXI_LLC_FLUSHED_SET1_HIGH_OFFSET);
  end
  ...
  assign cfg_set_partition0_low_we = addr_hit[8] & reg_we & !reg_error;
  assign cfg_set_partition0_low_wd = reg_wdata[31:0];

  assign cfg_set_partition0_high_we = addr_hit[9] & reg_we & !reg_error;
  assign cfg_set_partition0_high_wd = reg_wdata[31:0];

  assign cfg_set_partition1_low_we = addr_hit[10] & reg_we & !reg_error;
  assign cfg_set_partition1_low_wd = reg_wdata[31:0];

  assign cfg_set_partition1_high_we = addr_hit[11] & reg_we & !reg_error;
  assign cfg_set_partition1_high_wd = reg_wdata[31:0];

  assign cfg_set_partition2_low_we = addr_hit[12] & reg_we & !reg_error;
  assign cfg_set_partition2_low_wd = reg_wdata[31:0];

  assign cfg_set_partition2_high_we = addr_hit[13] & reg_we & !reg_error;
  assign cfg_set_partition2_high_wd = reg_wdata[31:0];

  assign cfg_set_partition3_low_we = addr_hit[14] & reg_we & !reg_error;
  assign cfg_set_partition3_low_wd = reg_wdata[31:0];

  assign cfg_set_partition3_high_we = addr_hit[15] & reg_we & !reg_error;
  assign cfg_set_partition3_high_wd = reg_wdata[31:0];

  assign cfg_set_partition4_low_we = addr_hit[16] & reg_we & !reg_error;
  assign cfg_set_partition4_low_wd = reg_wdata[31:0];

  assign cfg_set_partition4_high_we = addr_hit[17] & reg_we & !reg_error;
  assign cfg_set_partition4_high_wd = reg_wdata[31:0];

  assign cfg_set_partition5_low_we = addr_hit[18] & reg_we & !reg_error;
  assign cfg_set_partition5_low_wd = reg_wdata[31:0];

  assign cfg_set_partition5_high_we = addr_hit[19] & reg_we & !reg_error;
  assign cfg_set_partition5_high_wd = reg_wdata[31:0];

  assign cfg_set_partition6_low_we = addr_hit[20] & reg_we & !reg_error;
  assign cfg_set_partition6_low_wd = reg_wdata[31:0];

  assign cfg_set_partition6_high_we = addr_hit[21] & reg_we & !reg_error;
  assign cfg_set_partition6_high_wd = reg_wdata[31:0];

  assign cfg_set_partition7_low_we = addr_hit[22] & reg_we & !reg_error;
  assign cfg_set_partition7_low_wd = reg_wdata[31:0];

  assign cfg_set_partition7_high_we = addr_hit[23] & reg_we & !reg_error;
  assign cfg_set_partition7_high_wd = reg_wdata[31:0];

  assign cfg_set_partition8_low_we = addr_hit[24] & reg_we & !reg_error;
  assign cfg_set_partition8_low_wd = reg_wdata[31:0];

  assign cfg_set_partition8_high_we = addr_hit[25] & reg_we & !reg_error;
  assign cfg_set_partition8_high_wd = reg_wdata[31:0];

  assign cfg_set_partition9_low_we = addr_hit[26] & reg_we & !reg_error;
  assign cfg_set_partition9_low_wd = reg_wdata[31:0];

  assign cfg_set_partition9_high_we = addr_hit[27] & reg_we & !reg_error;
  assign cfg_set_partition9_high_wd = reg_wdata[31:0];

  assign cfg_set_partition10_low_we = addr_hit[28] & reg_we & !reg_error;
  assign cfg_set_partition10_low_wd = reg_wdata[31:0];

  assign cfg_set_partition10_high_we = addr_hit[29] & reg_we & !reg_error;
  assign cfg_set_partition10_high_wd = reg_wdata[31:0];

  assign cfg_set_partition11_low_we = addr_hit[30] & reg_we & !reg_error;
  assign cfg_set_partition11_low_wd = reg_wdata[31:0];

  assign cfg_set_partition11_high_we = addr_hit[31] & reg_we & !reg_error;
  assign cfg_set_partition11_high_wd = reg_wdata[31:0];

  assign cfg_set_partition12_low_we = addr_hit[32] & reg_we & !reg_error;
  assign cfg_set_partition12_low_wd = reg_wdata[31:0];

  assign cfg_set_partition12_high_we = addr_hit[33] & reg_we & !reg_error;
  assign cfg_set_partition12_high_wd = reg_wdata[31:0];

  assign cfg_set_partition13_low_we = addr_hit[34] & reg_we & !reg_error;
  assign cfg_set_partition13_low_wd = reg_wdata[31:0];

  assign cfg_set_partition13_high_we = addr_hit[35] & reg_we & !reg_error;
  assign cfg_set_partition13_high_wd = reg_wdata[31:0];

  assign cfg_set_partition14_low_we = addr_hit[36] & reg_we & !reg_error;
  assign cfg_set_partition14_low_wd = reg_wdata[31:0];

  assign cfg_set_partition14_high_we = addr_hit[37] & reg_we & !reg_error;
  assign cfg_set_partition14_high_wd = reg_wdata[31:0];

  assign commit_cfg_we = addr_hit[38] & reg_we & !reg_error;
  assign commit_cfg_wd = reg_wdata[0];

  assign commit_partition_cfg_we = addr_hit[39] & reg_we & !reg_error;
