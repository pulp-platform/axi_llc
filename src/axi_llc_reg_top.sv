...
module axi_llc_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[182] = (reg_addr == AXI_LLC_FLUSHED_SET0_LOW_OFFSET);
    addr_hit[183] = (reg_addr == AXI_LLC_FLUSHED_SET0_HIGH_OFFSET);
    addr_hit[184] = (reg_addr == AXI_LLC_FLUSHED_SET1_LOW_OFFSET);
    addr_hit[185] = (reg_addr == AXI_LLC_FLUSHED_SET1_HIGH_OFFSET);
    addr_hit[186] = (reg_addr == AXI_LLC_FLUSHED_SET2_LOW_OFFSET);
    addr_hit[187] = (reg_addr == AXI_LLC_FLUSHED_SET2_HIGH_OFFSET);
    addr_hit[188] = (reg_addr == AXI_LLC_FLUSHED_SET3_LOW_OFFSET);
    addr_hit[189] = (reg_addr == AXI_LLC_FLUSHED_SET3_HIGH_OFFSET);
    addr_hit[190] = (reg_addr == AXI_LLC_FLUSHED_SET4_LOW_OFFSET);
    addr_hit[191] = (reg_addr == AXI_LLC_FLUSHED_SET4_HIGH_OFFSET);
    addr_hit[192] = (reg_addr == AXI_LLC_FLUSHED_SET5_LOW_OFFSET);
    addr_hit[193] = (reg_addr == AXI_LLC_FLUSHED_SET5_HIGH_OFFSET);
    addr_hit[194] = (reg_addr == AXI_LLC_FLUSHED_SET6_LOW_OFFSET);
    addr_hit[195] = (reg_addr == AXI_LLC_FLUSHED_SET6_HIGH_OFFSET);
    addr_hit[196] = (reg_addr == AXI_LLC_FLUSHED_SET7_LOW_OFFSET);
    addr_hit[197] = (reg_addr == AXI_LLC_FLUSHED_SET7_HIGH_OFFSET);
  end
