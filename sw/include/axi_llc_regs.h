...
#define AXI_LLC_FLUSHED_SET0_LOW_REG_OFFSET 0x2e0

// Index-based Flushed Flag [63:32] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET0_HIGH_REG_OFFSET 0x2e4

// Index-based Flushed Flag [95:64] (lower 32 bit)
#define AXI_LLC_FLUSHED_SET1_LOW_REG_OFFSET 0x2e8

// Index-based Flushed Flag [127:96] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET1_HIGH_REG_OFFSET 0x2ec

// Index-based Flushed Flag [159:128] (lower 32 bit)
#define AXI_LLC_FLUSHED_SET2_LOW_REG_OFFSET 0x2f0

// Index-based Flushed Flag [191:160] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET2_HIGH_REG_OFFSET 0x2f4

// Index-based Flushed Flag [223:192] (lower 32 bit)
#define AXI_LLC_FLUSHED_SET3_LOW_REG_OFFSET 0x2f8

// Index-based Flushed Flag [255:224] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET3_HIGH_REG_OFFSET 0x2fc

// Index-based Flushed Flag [287:256] (lower 32 bit)
#define AXI_LLC_FLUSHED_SET4_LOW_REG_OFFSET 0x300

// Index-based Flushed Flag [319:288] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET4_HIGH_REG_OFFSET 0x304

// Index-based Flushed Flag [351:320] (lower 32 bit)
#define AXI_LLC_FLUSHED_SET5_LOW_REG_OFFSET 0x308

// Index-based Flushed Flag [383:352] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET5_HIGH_REG_OFFSET 0x30c

// Index-based Flushed Flag [415:384] (lower 32 bit)
#define AXI_LLC_FLUSHED_SET6_LOW_REG_OFFSET 0x310

// Index-based Flushed Flag [447:416] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET6_HIGH_REG_OFFSET 0x314

// Index-based Flushed Flag [479:448] (lower 32 bit)
#define AXI_LLC_FLUSHED_SET7_LOW_REG_OFFSET 0x318

// Index-based Flushed Flag [511:480] (upper 32 bit)
#define AXI_LLC_FLUSHED_SET7_HIGH_REG_OFFSET 0x31c
