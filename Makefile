...
set_partition_config:
	$(PYTHON) $(AXI_LLC_REGS_PATH) $(REGWIDTH) $(CACHENUMLINES) $(MAXTHREAD) ${CACHE_PARTITION}
	$(PYTHON) $(TYPEDEF_PATH) $(REGWIDTH) $(CACHENUMLINES) $(MAXTHREAD) ${CACHE_PARTITION}
	$(PYTHON) $(ASSIGN_PATH) $(REGWIDTH) $(CACHENUMLINES) $(MAXTHREAD) ${CACHE_PARTITION}
